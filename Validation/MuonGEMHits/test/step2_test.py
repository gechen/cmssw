...
# with command line options: step2 -s DIGI:pdigi_valid,L1,DIGI2RAW,RAW2DIGI,L1Reco,RECO:localreco --conditions auto:run2_mc --magField 38T_PostLS1 --beamspot Realistic50ns13TeVCollision --geometry Extended2023LReco --datatier GEN-SIM-DIGI-RAW --eventcontent FEVTDEBUGHLT --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2023LReco -n 10 --no_exec --filein file:out_sim.root --fileout out_reco.root --python_filename step2_test.py --era Phase2
